...
function ChoiceMenu()
	repeat
		...
		if userchoice == "GO" then io.write(Determiner(io.open("input.txt","r"), io.open("output.txt","w+"), string.lower(userchoice))) else io.write(Determiner(string.lower(userchoice))) end
